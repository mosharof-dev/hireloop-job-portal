...
export default function Footer() {
  return (
    <footer className="w-full bg-[#060608] text-white border-t border-white/30">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 pt-16 pb-12">
          ...
          <div className="md:col-span-7 grid grid-cols-2 sm:grid-cols-3 gap-8">
            {footerSections.map((section) => (
              <div key={section.title} className="flex flex-col gap-4">
                <h3 className="text-blue-400 font-semibold text-[14px] tracking-wider uppercase">
                  {section.title}
                </h3>
        ...
        <div className="flex flex-col sm:flex-row items-center justify-between gap-6 pt-12 border-t border-white/20 w-full">
          {/* Social Media Links */}
          ...
          <div className="flex flex-col sm:flex-row items-center gap-4 text-[13px] text-zinc-500 font-medium text-center sm:text-right">
            <span>&copy; 2026 Mosharof. All rights reserved.</span>
