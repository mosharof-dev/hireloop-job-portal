...
import { FiMenu, FiX, FiSearch, FiUsers, FiCreditCard, FiChevronRight } from 'react-icons/fi';
                ...
                <li key={link.href}>
                  ...
                  >
                    <div className="flex items-center gap-3">
                      {link.label === 'Browse Jobs' && <FiSearch className="w-5 h-5 opacity-80" />}
                      {link.label === 'Company' && <FiUsers className="w-5 h-5 opacity-80" />}
                      {link.label === 'Pricing' && <FiCreditCard className="w-5 h-5 opacity-80" />}
