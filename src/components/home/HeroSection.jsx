...
const HeroSection = () => {
  return (
    <div className="relative overflow-hidden bg-[#030303] text-white min-h-[95vh] flex items-center pt-10">
      ...
      <div className="container mx-auto px-4 sm:px-6 relative z-10 flex flex-col items-center text-center">
        ...
        >
          ...
          <p className="text-base sm:text-lg lg:text-xl text-zinc-400 mb-10 max-w-2xl mx-auto leading-relaxed">
            Join thousands of professionals landing roles at top companies. Search millions of jobs and manage your applications in one seamless platform.
          </p>
          ...
          >
            ...
            {['Software Engineer', 'Product Manager', 'Remote', 'UI/UX'].map((tag) => (
              <span key={tag} className="px-3 py-1 rounded-full border border-white/10 bg-white/5 text-zinc-300 hover:bg-white/10 hover:text-white transition-colors cursor-pointer text-xs">
                {tag}
              </span>
            ))}
          </motion.div>
          ...
          >
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-[10px] text-zinc-400">Senior React Developer</p>
              </div>
            </div>
          ...
          >
            <div className="flex items-start justify-between">
              <div className="flex items-center gap-2">
                ...
                <div>
                  <p className="font-bold text-xs text-white">Interview Scheduled</p>
            ...
            <div className="bg-zinc-800/50 rounded-lg p-2 border border-white/5 flex items-center gap-2">
              ...
              <div>
                <p className="text-[10px] font-semibold text-white">Google LLC</p>
