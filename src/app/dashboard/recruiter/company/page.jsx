      ...
      <div className=" mx-auto">
        {!company ? (
          <div className="flex flex-col items-center justify-center p-12 border border-zinc-800 rounded-xl bg-[#121212] text-center">
            ...
            <Button onPress={() => setIsModalOpen(true)} className="bg-white text-black font-medium">
              Register Company
            </Button>
          </div>
        ) : (
          <div className="p-6 md:p-8 border border-zinc-800 rounded-xl bg-[#121212] flex flex-col gap-6 shadow-xl">
            <div className="flex flex-col md:flex-row justify-between items-start gap-4">
              <div className="flex items-center gap-5">
                {company.logoUrl ? (
                  <img src={company.logoUrl} alt="Logo" className="w-20 h-20 rounded-xl border border-zinc-700 object-cover" />
                ) : (
                ...
                <div>
                  ...
                  <div className="flex flex-wrap items-center gap-2 text-zinc-400 text-sm">
                    ...
                    <span>•</span>
                    <span className="flex items-center gap-1"><FiMapPin /> {company.location}</span>
                  </div>
                </div>
              </div>
              
              <div className="flex items-center gap-3">
                <Button size="sm" variant="flat" className="bg-zinc-800 text-white" onPress={() => setIsModalOpen(true)}>
            ...
            <div className="pt-6 border-t border-zinc-800 grid grid-cols-1 md:grid-cols-3 gap-6">
              <div className="col-span-1 md:col-span-2">
                <h3 className="text-sm font-medium text-zinc-400 mb-2">About Company</h3>
                <p className="text-zinc-200 text-sm leading-relaxed">{company.description}</p>
              </div>
              <div className="flex flex-col gap-4">
                <div>
                  <h3 className="text-sm font-medium text-zinc-400 mb-1">Website</h3>
                  <a href={`https://${company.website}`} target="_blank" rel="noreferrer" className="text-blue-400 text-sm hover:underline">
                    {company.website}
                  </a>
                </div>
                <div>
                  <h3 className="text-sm font-medium text-zinc-400 mb-1">Company Size</h3>
                  <p className="text-zinc-200 text-sm">{company.employeeCount}</p>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="bg-[#18181b] border border-zinc-800 rounded-xl w-full max-w-2xl shadow-2xl flex flex-col max-h-[90vh] overflow-y-auto">
            ...
            <div className="flex justify-between items-start p-6 border-b border-zinc-800/50">
              <div>
                ...
                <p className="text-zinc-400 text-sm mt-1">Enter your business details.</p>
              </div>
            ...
            <Form onSubmit={onSubmit} className="p-6 flex flex-col gap-6">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6 w-full">
                ...
                <TextField isRequired name="name" className="flex flex-col gap-2 w-full"
                ...
                <div className="flex flex-col gap-2">
                  <Select 
                    ...
                    defaultSelectedKeys={company?.industry ? [company.industry] : []}
                    classNames={{ trigger: "bg-[#27272a] border-none" }}
                  >
                    <Label className="text-sm font-medium text-zinc-200">Industry / Category</Label>
                    <Select.Trigger>
                      <Select.Value />
                      <Select.Indicator />
                    </Select.Trigger>
                ...
                <TextField isRequired name="website" className="flex flex-col gap-2 w-full"
                ...
                <TextField isRequired name="location" className="flex flex-col gap-2 w-full" defaultValue={company?.location}>
                ...
                <div className="flex flex-col gap-2">
                  <Select 
                    ...
                    defaultSelectedKeys={company?.employeeCount ? [company.employeeCount] : []}
                    classNames={{ trigger: "bg-[#27272a] border-none" }}
                  >
                    <Label className="text-sm font-medium text-zinc-200">Employee Count Range</Label>
                    <Select.Trigger>
                      <Select.Value />
                      <Select.Indicator />
                    </Select.Trigger>
                ...
                <div className="flex flex-col gap-2">
                  ...
                  <div className="flex items-center gap-4">
                    ...
                    <div className="text-xs text-zinc-400">
                      ...
                      {(logoUrl || company?.logoUrl) && <span className="text-green-500 mt-1 block">Image Ready!</span>}
                    </div>
                  </div>
                </div>
              ...
              <TextField isRequired name="description" className="flex flex-col gap-2 w-full" defaultValue={company?.description}>
                <Label className="text-sm font-medium text-zinc-200">Brief Description</Label>
                <TextArea 
